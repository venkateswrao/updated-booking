...
$email=$_POST['email'];
 ...
 $sel = mysql_query("SELECT * FROM empdata WHERE email = '".$email."'");
 echo count($sel);
$res = mysql_fetch_array($sel);
 $id=$res['id'];
if($res>0){
$code=rand();
$pass=base64_encode($code);
$sql = mysql_query("UPDATE empdata SET pass='$pass' WHERE email = '".$email."'");
if($sql){
$to=$email;
$subject="new password";
 echo $message="new password ".$code;
