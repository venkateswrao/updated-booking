	...
	<div id="header" class="container">
		...
		<div id="menu">
			<ul>
				...
				<li class="active"><a href="activeusers.php" accesskey="3" title="">ActiveRecords</a></li>
				<li><a href="dactiveusers.php" accesskey="3" title="">DActiveRecords</a></li>
...
$records = mysql_query("select * from empdata where flag='1'");
...
if ($totalpages > 1) {
	...
	if ($page > 1) {
		...
		$prev = $page -1;
?>
		<a href="activeusers.php?page=<?php echo $prev; ?>">Prev</a> 
	...
	for ($i = 1; $i < $totalpages; $i++) {
		...
		if ($i != $page) {
?>	
		<a href="activeusers.php?page=<?php echo $i; ?>"><?php echo $i; ?></a> 
...
?>
	...
	if ($page < $totalpages) {
		...
		$next = $page +1;
?>
		<a href="activeusers.php?page=<?php echo $next; ?>">next</a> 
