...
function ConfirmDelete()
{
  ...
  var flag = 0;
  for(i=0;i<conunt;i++){
	   if(document.myform["empids[]"][i].checked)
	   {
		   flag ++;
	   }
       }
...
?>
   ...
   <div class="Row" align="center">
    ...
    <div class="Cell">
           <p><input type="checkbox" name="active[]" id="checkbox[]"  "javascript:return ConfirmActive()"; value="<?php echo $id?>" >Active</p>
                </div>
...
<div>
<p><input name="delete" type="submit" id="delete" value="Delete" Onclick="javascript:return ConfirmDelete()";></p>
</div>
<div>
